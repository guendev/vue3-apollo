...
export type PostDetailFragment = { __typename?: 'Post', id: number, title?: string | null, body?: string | null } & { ' $fragmentName'?: 'PostDetailFragment' };
...
export type PostsQuery = { __typename?: 'Query', posts?: Array<(
    ...
    & { ' $fragmentRefs'?: { 'PostDetailFragment': PostDetailFragment } }
  ) | null> | null };
...
export type TodosQuery = { __typename?: 'Query', todos?: Array<{ __typename?: 'Todo', id: number } | null> | null };
